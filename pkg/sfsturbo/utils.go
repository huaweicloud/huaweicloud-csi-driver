...
func NewControllerServer(d *SfsTurboDriver) *controllerServer {
	return &controllerServer{
		Driver: d,
	}
}

func NewIdentityServer(d *SfsTurboDriver) *identityServer {
	return &identityServer{
		Driver: d,
	}
}

func NewNodeServer(d *SfsTurboDriver) *nodeServer {
	return &nodeServer{
		Driver:   d,
	}
}
...
func bytesToGiB(sizeInBytes int64) int {
	sizeInGiB := int(sizeInBytes / tInGiB)

	if int64(sizeInGiB)*tInGiB < sizeInBytes {
		// Round up
		return sizeInGiB + 1
	}
